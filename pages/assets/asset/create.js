...
export default function AddAsset({ fetchItems }) {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    try {
      ...
      if (
        ...
        let errorMessage = data.message || data.title || "Failed to create asset";
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={handleClose} aria-labelledby="add-asset-modal">
        <Box sx={style}>
          <Formik
            initialValues={{
              AssetCode: "",
              ...
              CustodianId: "",
              DepartmentId: "",
              EntityId: 1, // default EntityId assuming 1 is primary
              Barcode: "",
              WarrantyExpiry: "",
              UsefulLifeMonths: "",
              SalvageValue: "",
