...
import FrontLRDocument from "./frontlr-doc";
      ...
      >
        <Grid item xs={12} display="flex" justifyContent="space-between">
          ...
          <Box display="flex" sx={{ gap: "10px" }}>
            <Link href={`/inquiry/edit-inquiry/cap/info/?id=${inquiry ? inquiry.inquiryId : ""}&option=${inquiry ? inquiry.optionId : ""}`}>
              <Button variant="outlined" color="primary">
                previous
              </Button>
            </Link>
            <Link href={`/inquiry/edit-inquiry/cap/summary/?id=${inquiry ? inquiry.inquiryId : ""}&option=${inquiry ? inquiry.optionId : ""}`}>
              <Button
                variant="outlined"
                color="primary"
        ...
        <Grid item xs={12}>
          <Grid container>
            <Grid item xs={12}>
              <FrontDocument inquiry={inquiry} onUpload={handleUploadStatus} />
            </Grid>
            <Grid item xs={12}>
              <FrontLRDocument inquiry={inquiry} onUpload={handleUploadStatus} />
            </Grid>
            <Grid item xs={12}>
              <BackDocument inquiry={inquiry} onUpload={handleUploadStatus} />
            </Grid>
            <Grid item xs={12}>
              <LSideDocument inquiry={inquiry} onUpload={handleUploadStatus} />
            </Grid>
            <Grid item xs={12}>
              <RSideDocument inquiry={inquiry} onUpload={handleUploadStatus} />
            </Grid>
            <Grid item xs={12}>
