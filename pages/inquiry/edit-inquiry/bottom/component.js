      ...
      const response = await fetch(
        `${BASE_URL}/ComponentPanel/CreateComponentPanel`,
        {
          ...
          body: JSON.stringify({
            ...
            ComponentFirstRows: 10,
            ComponentValue: value == 9 ? textFieldValue : (value == 12 ? selectedBottomValue : ""),
          }),
        }
      );
    } else {
      ...
      >
        <Grid item xs={12} display="flex" justifyContent="space-between">
          ...
          <Box display="flex" sx={{ gap: "10px" }}>
            ...
            <Link href={`/inquiry/edit-inquiry/bottom/document-panel/?id=${inquiry ? inquiry.inquiryId: ""}&option=${inquiry ? inquiry.optionId: ""}`}>
              <Button
                variant="outlined"
                color="primary"
            ...
            <Grid item p={1} xs={12} lg={4} md={6}>
              ...
              >
                <FormControlLabel
                  ...
                  label="Cord Color"
                />
                {textBoxView ? <TextField value={textFieldValue}
                  onChange={handleTextFieldChange} fullWidth /> : ""}
              </Card>
            </Grid>
          </Grid>
        </Grid>
