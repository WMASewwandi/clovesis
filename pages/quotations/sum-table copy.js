...
export default function SummaryTable() {
  ...
  const fetchQuotationDataList = async () => {
    try {
      ...
      const intProPer = data.result?.apprvedProfitPercentage;
      const intSelPri = data.result?.apprvedSellingPrice;
      const intPro = data.result?.apprvedUnitProfit;
      const intTotPro = data.result?.apprvedTotalProfit;
      const intRev = data.result?.apprvedRevanue;
  ...
  useEffect(() => {
    ...
    localStorage.setItem("approveddata", JSON.stringify(cleanData));
