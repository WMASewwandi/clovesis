  ...
  return (
    <>
      ...
      <div className={styles.pageTitle}>
        ...
        <ul>
          <li>
            <Link href="/master/bom">Bill Of Materials</Link>
          </li>
                ...
                >
                  <TableHead>
                    <TableRow sx={{ background: "#757fef" }}>
                      ...
                      <TableCell sx={{ color: "#fff" }}>Stock Keeping Unit</TableCell>
                      <TableCell sx={{ color: "#fff" }}>Printer</TableCell>
