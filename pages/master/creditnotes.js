...
import CreditnotesView from "@/components/UIElements/Modal/CreditnotesView";
...
const CNN = () => {
  ...
  const navigateToCreate = () => {
    router.push({
      pathname: "/master/create-creditnotes",
    });
  };
                ...
                {paginatedData.length === 0 ? (
                  ...
                  paginatedData.map((item, index) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>{item.remark || "No Remarks"}</TableCell>
