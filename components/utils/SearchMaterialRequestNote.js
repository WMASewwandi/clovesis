...
const SearchMaterialRequestNote = forwardRef(({
  label = "Material Request Note",
  placeholder = "Search material request notes by keyword",
  tokenKey = "token",
  projectId,
  onSelect,
  onClear,
  ...
  const handleSearch = async (value) => {
    ...
    try {
      ...
      const url = `${BASE_URL}/MaterialRequestNote/GetApprovedMaterialRequestNotesByProject?${query}`;
      ...
      console.error("Error searching material request notes:", error);
      setResults([]);
      setShowDropdown(false);
    }
  };
...
SearchMaterialRequestNote.displayName = "SearchMaterialRequestNote";

export default SearchMaterialRequestNote;
