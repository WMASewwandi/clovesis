...
const SearchProjectByKeyword = forwardRef(({
  label = "Project",
  ...
  const handleSearch = async (value) => {
    ...
    const url = `${BASE_URL}/Project/GetProjectsByKeyword?${query}`;
        ...
        >
          <List dense>
            {results.map((item, index) => (
              ...
              >
                <ListItemText primary={getProjectLabel(item)} />
              </ListItem>
            ))}
          </List>
        </Paper>
...
SearchProjectByKeyword.displayName = "SearchProjectByKeyword";

export default SearchProjectByKeyword;
